        ...
        <section className='questionnaire'>
            <header>
                ...
                <Link to="/Admin-SKCK-WatutumouDua" className='button landing-link'>Layanan SKCK</Link>
                    <Link to="/Admin-SKKK-WatutumouDua" className='button landing-link active'>Layanan SKKK</Link>
...
export default AdminSKKKWatutumouDua